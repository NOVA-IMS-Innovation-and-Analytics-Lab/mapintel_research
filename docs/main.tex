...
\begin{table}[H]
  ...
  \caption{Example queries and their top 3 results and respective scores. The results are computed according to the methodology described in \ref{query}.}
  \label{query_results}
\end{table}
...
\begin{figure}[H]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{subfigure}[b]{0.44\linewidth}
      \includegraphics[width=\linewidth]{./assets/orig_umap_train_plot_zoom}
      \caption{Original labels}
      \label{umap_test_plots:a}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\linewidth}
      \includegraphics[width=\linewidth]{./assets/top_umap_train_plot_zoom}
      \caption{Topic labels}
      \label{umap_test_plots:b}
    \end{subfigure}
  }
