...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/orig_umap_train_plot_labels}
			\caption{Original labels}
			\label{umap_train_plots:a}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/top_umap_train_plot_labels}
...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/orig_umap_test_plot_labels}
			\caption{Original labels}
			\label{umap_test_plots:a}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/top_umap_test_plot_labels}
			\caption{Topic labels}
...
\begin{figure}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/orig_umap_train_plot_zoom_labels}
			\caption{Original labels}
			\label{umap_test_plots:a}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\linewidth}
			\includegraphics[width=\linewidth]{./assets/top_umap_train_plot_zoom_labels}
			\caption{Topic labels}
			\label{umap_test_plots:b}
		\end{subfigure}
	}
